        ...
        try:
            ...
            if needs_clarification:
                try:
                    ...
                    clarification_options = ["Please provide more specific details about what you want to change."]
            ...
            return ProcessedEdit(
                ...
                processing_metadata={
                    ...
                    "elements_in_design": len(self._extract_elements_from_design(current_state.wireframe_json)) if current_state else 0,
