    ...
    async def get_client(self) -> redis.Redis:
        ...
        if self._redis_client is None:
            ...
            try:
                ...
                logger.info(f"Redis pool initialized with {self.max_connections} max connections")
...
def get_redis_pool_manager(redis_url: str = "redis://localhost:6379") -> RedisPoolManager:
