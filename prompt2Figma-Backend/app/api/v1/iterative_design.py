...
from app.core.security import (
    get_rate_limiter, get_security_monitor,
    InputSanitizer, SecurityError
)
...
async def edit_design_session(
    ...
    try:
        ...
        try:
            sanitized_prompt, warnings = InputSanitizer.sanitize_prompt(request.edit_prompt)
            if warnings:
                await security_monitor.log_security_event(
...
async def get_user_analytics(
    ...
    """
    try:
        engagement_metrics = await analytics_manager.get_user_engagement_metrics(user_id)
...
async def get_session_security_events(
    ...
    """
    try:
        from app.core.security import get_security_monitor, InputSanitizer, SecurityError
...
async def get_rate_limit_status(session_id: str):
    ...
    """
    try:
        from app.core.security import get_rate_limiter, InputSanitizer, SecurityError
...
async def reset_rate_limit(session_id: str):
    ...
    """
    try:
        from app.core.security import get_rate_limiter, get_security_monitor, InputSanitizer, SecurityError
