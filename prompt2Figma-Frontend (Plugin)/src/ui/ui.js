...
window.addEventListener("DOMContentLoaded", () => {
  ...
  promptInput.addEventListener("input", (e) => {
    ...
    if (count > 2700) { // 90% of limit
      charCount.style.color = "#ef4444"; // Red
    } else if (count > 2400) { // 80% of limit
  ...
  function showStatus(type, title, message) {
    ...
    // Remove existing status classes from status card
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (helpLink) {
    helpLink.addEventListener('click', (e) => {
      ...
      showStatus('info', 'Help & Support', 'For help, visit our documentation or contact support at support@prompt2figma.com');
  ...
  if (docsLink) {
    docsLink.addEventListener('click', (e) => {
      e.preventDefault();
      // Open documentation (in a real scenario, this would open external link)
      showStatus('info', 'Documentation', 'Documentation is available at docs.prompt2figma.com');
  ...
  if (feedbackLink) {
    feedbackLink.addEventListener('click', (e) => {
      e.preventDefault();
      // Show feedback form or link
      showStatus('info', 'Feedback', 'We\'d love to hear from you! Send feedback to feedback@prompt2figma.com');
